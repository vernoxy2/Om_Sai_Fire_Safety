          ...
          <div className="text-right space-y-6 container lg:px-0">
            ...
            <p className="text-lg md:text-3xl leading-relaxed text-right">
              ...
              <span className="font-semibold">
                Om Sai Fire Safety Solutions
              </span>
              , we are dedicated to fire safety and protection that goes beyond
              ...
              <span className="font-semibold">
                your premises safe and compliant.
              </span>
            </p>
            ...
            <p className="text-lg md:text-3xl leading-relaxed text-right">
              As a trusted{" "}
              <span className="font-semibold">
                fire safety company in India
              </span>
              , our goal is to deliver reliable fire safeguard solutions that
              protect lives, property, and businesses.{" "}
              <span className="font-semibold">With a professional team</span>{" "}
              and a customer-first approach, we ensure complete{" "}
              <span className="font-semibold">
