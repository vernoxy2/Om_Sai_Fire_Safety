  ...
  return (
    <section style={Style} className="py-32">
      <div className="container text-start">
        <div className="w-11/12 lg:w-1/2 bg-gradient-to-r backdrop-blur-sm from-primary-start/60 to-transparent p-7 border-l-[3px] border-Border mt-20 mr-auto md:space-y-5">
          <div>
