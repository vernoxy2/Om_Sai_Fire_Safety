  ...
  <form className="space-y-6">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="firstName" className="font-semibold text-white text-2xl">
          First Name
        </label>
        <input
          id="firstName"
      ...
      {/* Last Name */}
      <div className="flex flex-col gap-2">
        <label htmlFor="lastName" className="font-semibold text-white text-2xl">
          Last Name
        </label>
        <input
          id="lastName"
      ...
      {/* Phone Number */}
      <div className="flex flex-col gap-2">
        <label htmlFor="phone" className="font-semibold text-white text-2xl">
          Phone Number
        </label>
        <input
          id="phone"
      ...
      {/* Email Address */}
      <div className="flex flex-col gap-2">
        <label htmlFor="email" className="font-semibold text-white text-2xl">
          Email Address
        </label>
        <input
          id="email"
      ...
      <div className="flex flex-col gap-2 md:col-span-2">
        <label htmlFor="message" className="font-semibold text-white text-2xl">
          Message
        </label>
        <textarea
          id="message"
